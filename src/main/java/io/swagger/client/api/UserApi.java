...
public class UserApi {
     ...
     */
    public InlineResponse2001 getUser() throws ApiException {
        ApiResponse<InlineResponse2001> resp = getUserWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse2001> getUserWithHttpInfo() throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call getUserAsync(final ApiCallback<InlineResponse2001> callback) throws ApiException {
