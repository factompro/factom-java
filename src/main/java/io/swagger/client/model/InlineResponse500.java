...
public class InlineResponse500 {
  ...
  public InlineResponse500 result(Boolean result) {
    this.result = result;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse500 code(Integer code) {
   ...
   /**
   * Error codes:   * &#x60;1510&#x60; - Internal server error   * &#x60;1520&#x60; - API key limitation error 
   * @return code
  **/
  @Schema(example = "1510", description = "Error codes:   * `1510` - Internal server error   * `1520` - API key limitation error ")
   ...
   * @return error
  **/
  @Schema(example = "Internal server error", description = "Error description")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.result, inlineResponse500.result) &&
        Objects.equals(this.code, inlineResponse500.code) &&
        Objects.equals(this.error, inlineResponse500.error);
  }
