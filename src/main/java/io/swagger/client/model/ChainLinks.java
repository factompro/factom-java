...
/**
 * Links to all, first &amp; last entries of the chain
 */
@Schema(description = "Links to all, first & last entries of the chain")
...
public class ChainLinks extends ArrayList<Link> {
