...
/**
 * One or multiple external ids identifying chain or entry presented as an **array** of **base64 strings**
 */
@Schema(description = "One or multiple external ids identifying chain or entry presented as an **array** of **base64 strings**")
...
public class ExtIds extends ArrayList<byte[]> {
