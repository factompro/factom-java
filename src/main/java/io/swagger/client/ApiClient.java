...
public class ApiClient {
    ...
    private String basePath = "https://api.factom.pro/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("Bearer Authorization", new OAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.factom.pro/v1
